      ...
      <div className="about-pic">
        <div className="about-info">
          ...
          <p>
            ...
            purpose (injected humour and the like). Lorem Ipsum is simply dummy text of the printing and typesetting
            ...
            recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum. Why do we
            use it? It is a long established fact that a reader will be distracted by the readable content of a page
            ...
            over the years, sometimes by accident, sometimes on purpose (injected humour and the like). electronic
